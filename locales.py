...
# Mutable runtime copy of the active theme. Updated in-place by the controller
# so that view widgets referencing THEME directly always see current colours.
THEME: dict = dict(THEMES["dark"])

MEDIA_TYPES: tuple[str, ...] = ("book", "manga", "anime")
STATUSES: tuple[str, ...] = ("Переглянуто", "В процесі", "Заплановано", "Покинуто")
SORT_KEYS = ["title", "rating", "year"]
DEFAULT_LANG = "uk"
DEFAULT_THEME = "dark"

# Named constants — single source of truth for internal status/type values.
# Use these throughout the codebase instead of raw string literals.
